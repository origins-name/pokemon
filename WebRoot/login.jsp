...
<head>
 ...
 function yundongyuanReg()
  {
          var url="<%=path %>/yundongyuanReg.jsp";
          var n="";
          var w="480px";
          var h="500px";
...
<body leftmargin="0" topmargin="0">
	<table width="559" height="423" border="0" align="center" cellpadding="0" cellspacing="0"  background="<%=path %>/images/dfff.jpg">
	 <tr>
	    <td><div align="center" style="FONT-WEIGHT: bold; FONT-SIZE: 30pt;">&nbsp;</div></td>
	 </tr>
	 <tr>
		<td width="559">
			<form name="ThisForm" method="POST" action="">
				<table width="410" height="198" border="0" align="right" cellpadding="0" cellspacing="0">
					<tr>
						<td height="10" colspan="2"><div style="FONT-WEIGHT: bold; FONT-SIZE: 13pt;">××学院田径运动会的报名系统</div></td>
					</tr>
			        <tr>
					...
					<tr>
						<td colspan="2" valign="top">&nbsp; &nbsp; &nbsp; &nbsp;
							...
							<input name="Submit2" type="button" class="submit1" value="注册" onclick="yundongyuanReg()">
